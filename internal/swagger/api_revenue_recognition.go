...
/*
RevenueRecognitionApiService Compute monthly recognized revenue
...
func (a *RevenueRecognitionApiService) RecognizedRevenuePost(ctx context.Context, body RevenueRecognitionInput) ([]RevenueRecognitionEntry, *http.Response, error) {
	var (
		...
		localVarReturnValue []RevenueRecognitionEntry
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/recognized_revenue/"
