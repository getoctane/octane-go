...
/*
CustomersApiService Delete Accounting Customer
...
func (a *CustomersApiService) CustomersCustomerNameAccountingDelete(ctx context.Context, customerName string) (*http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/customers/{customer_name}/accounting"
...
/*
CustomersApiService Create Accounting Customer
...
func (a *CustomersApiService) CustomersCustomerNameAccountingGenerationPost(ctx context.Context, customerName string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/customers/{customer_name}/accounting/generation"
	localVarPath = strings.Replace(localVarPath, "{"+"customer_name"+"}", fmt.Sprintf("%v", customerName), -1)
...
/*
CustomersApiService Get Accounting Customer ID
...
func (a *CustomersApiService) CustomersCustomerNameAccountingGet(ctx context.Context, customerName string) (AccountingCustomer, *http.Response, error) {
	var (
		...
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue AccountingCustomer
	)
...
/*
CustomersApiService Connect Accounting Customer
...
/*
CustomersApiService Get Accrued Revenue
...
/*
CustomersApiService Get Active Subscription
...
/*
CustomersApiService Delete Customer&#x27;s Credit Top Off Plan
...
func (a *CustomersApiService) CustomersCustomerNameCreditTopOffPlanDelete(ctx context.Context, customerName string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/customers/{customer_name}/credit_top_off_plan"
	localVarPath = strings.Replace(localVarPath, "{"+"customer_name"+"}", fmt.Sprintf("%v", customerName), -1)
...
/*
CustomersApiService Get Customer&#x27;s Credit Top Off Plan
...
func (a *CustomersApiService) CustomersCustomerNameCreditTopOffPlanGet(ctx context.Context, customerName string) (CreditTopOffPlan, *http.Response, error) {
	var (
		...
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue CreditTopOffPlan
	)
...
/*
CustomersApiService Create Customer&#x27;s Credit Top Off Plan
...
/*
CustomersApiService Update Customer&#x27;s Credit Top Off Plan
...
/*
CustomersApiService Delete Discount
...
func (a *CustomersApiService) CustomersCustomerNameDiscountsDelete(ctx context.Context, body DeleteDiscountInputArgs, customerName string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/customers/{customer_name}/discounts"
	localVarPath = strings.Replace(localVarPath, "{"+"customer_name"+"}", fmt.Sprintf("%v", customerName), -1)
...
/*
CustomersApiService Add Discounts to a Subscription
...
/*
CustomersApiService Get Feature Status
...
/*
CustomersApiService Validate customer address.
...
func (a *CustomersApiService) CustomersCustomerNameIntegrationTaxAvalaraAddressValidGet(ctx context.Context, customerName string) (ValidateAddressResp, *http.Response, error) {
	var (
		...
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue ValidateAddressResp
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/customers/{customer_name}/integration/tax/avalara/address/valid"
	localVarPath = strings.Replace(localVarPath, "{"+"customer_name"+"}", fmt.Sprintf("%v", customerName), -1)
...
/*
CustomersApiService Get Customer Avalara Settings
...
func (a *CustomersApiService) CustomersCustomerNameIntegrationTaxAvalaraSettingsGet(ctx context.Context, customerName string) (CustomerAvalaraSettings, *http.Response, error) {
	var (
		...
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue CustomerAvalaraSettings
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/customers/{customer_name}/integration/tax/avalara/settings"
	localVarPath = strings.Replace(localVarPath, "{"+"customer_name"+"}", fmt.Sprintf("%v", customerName), -1)
...
/*
CustomersApiService Update customer Avalara settings
...
/*
CustomersApiService Get Customer Invoices
...
/*
CustomersApiService Get All Customer Metadata
...
func (a *CustomersApiService) CustomersCustomerNameMetadataGet(ctx context.Context, customerName string) ([]CustomerMetadata, *http.Response, error) {
	var (
		...
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue []CustomerMetadata
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/customers/{customer_name}/metadata"
	localVarPath = strings.Replace(localVarPath, "{"+"customer_name"+"}", fmt.Sprintf("%v", customerName), -1)
...
/*
CustomersApiService Add metadata to a customer
...
/*
CustomersApiService Get PaymentGatewayCredential
...
/*
CustomersApiService Add PaymentGatewayCredential
...
/*
CustomersApiService Get Customer Payment Method Status
...
/*
CustomersApiService Get Scheduled Subscriptions
...
/*
CustomersApiService Get Customer Status
...
/*
CustomersApiService Modify Add Ons on Subscription
...
func (a *CustomersApiService) CustomersCustomerNameSubscriptionAddOnsPost(ctx context.Context, body []SubscriptionAddOnItem, customerName string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/customers/{customer_name}/subscription/add_ons"
	localVarPath = strings.Replace(localVarPath, "{"+"customer_name"+"}", fmt.Sprintf("%v", customerName), -1)
...
/*
CustomersApiService Get Usage By Meter
